                        ...
                        <div className="about-content">
                            <div className="row">
                                ...
                                <div className="text">
                                    ...
                                    <h6>A <span>Software Engineer</span> based in <span>Rwanda</span></h6>
                                    <p>I’m a tech enthusiast, full stack developer, passionate about programming and IT in general.</p>
                                    <div className="info">
                                        <div className="list">
                                            <label>Email:</label>
